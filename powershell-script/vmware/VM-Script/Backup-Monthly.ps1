...
Backup-VirtualMachine -server $server -credential $credential -vm $vm_monthly -path $path_log_monthly -folder $folder_monthly -datastore $datastore_backup -policy 'Monthly'